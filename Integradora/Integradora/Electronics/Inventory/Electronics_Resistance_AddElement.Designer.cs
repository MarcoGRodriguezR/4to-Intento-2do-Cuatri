...
{
    partial class Electronics_Resistance_AddElement
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            UnitsLBL = new Label();
            NameLBL = new Label();
            ResistanceTXT = new TextBox();
            ResistanceLBL = new Label();
            StatusLBL = new Label();
            SuspendLayout();
            // 
            // UnitsTXT
            ...
            // ResistanceTXT
            // 
            ResistanceTXT.Font = new Font("Segoe UI", 16F);
            ResistanceTXT.Location = new Point(520, 58);
            ResistanceTXT.Name = "ResistanceTXT";
            ResistanceTXT.Size = new Size(121, 36);
            ResistanceTXT.TabIndex = 21;
            ResistanceTXT.TextChanged += ResistanceTXT_TextChanged;
            // 
            // ResistanceLBL
            // 
            ResistanceLBL.AutoSize = true;
            ResistanceLBL.Font = new Font("Segoe UI", 16F);
            ResistanceLBL.Location = new Point(520, 12);
            ResistanceLBL.Name = "ResistanceLBL";
            ResistanceLBL.Size = new Size(122, 30);
            ResistanceLBL.TabIndex = 22;
            ResistanceLBL.Text = "Resistencia:";
            // 
            // StatusLBL
            // 
            ...
            Controls.Add(ResistanceLBL);
            Controls.Add(ResistanceTXT);
        ...
        private TextBox ResistanceTXT;
        private Label ResistanceLBL;
